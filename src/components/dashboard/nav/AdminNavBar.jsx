...
Nav bar for admin dashboard. Left side, visible when screen large. Top, dropdown hamburger menu when screen small.

Props: 
 - name / role: passed from parent. used to display "loggin in as...".
 - tab: modified in this component to tell parent which content component to display.

Parents: AdminDashboard
Children: SignOut, LoggedInAs
    ...
    <div className='nav-bar'>
      ...
      <div className='nav-small'>
        {showNav ? (<div onClick={handleShowNav} className='nav-modal'><div className='nav-modal-content'>
          ...
          <div tabindex="0" aria-label="Announcements Nav Option" className='nav-item' onClick={() => handleNavClick("Announcements")}><FontAwesomeIcon icon={faMessage} className='icon' />Announcements</div>
          <div tabindex="0" aria-label="Requests Nav Option" className='nav-item' onClick={() => handleNavClick("Requests")}><FontAwesomeIcon icon={faQuestionCircle} className='icon' />Requests</div>
          <div tabindex="0" aria-label="Payments Nav Option" className='nav-item' onClick={() => handleNavClick("Payments")}><FontAwesomeIcon icon={faCreditCard} className='icon' />Payments</div>
          <div tabindex="0" aria-label="Instruments Nav Option" className='nav-item' onClick={() => handleNavClick("Instruments")}><FontAwesomeIcon icon={faGuitar} className='icon' />Instruments</div>
