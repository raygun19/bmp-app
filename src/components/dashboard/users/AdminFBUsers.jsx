...
Component: AdminFBUsers

top level component for admin users. A list of users. Gets data from firebase collections 'students', 'teachers' and 
'administrators' and passes it to a list of 'FBUser's.

Props: 
 - render: passed to SignUp to rerender dashboard

Parents: Users
Children: FBUser, SignUp

*/

function AdminFBUsers({ render }) {
