...
const StudentClassList = ({ render, evts, locs, teachers, students }) => {
  ...
  return (
    <div className='classes-list-border'>
      ...
      {selectedEvent && (
        <StudentViewEventDetails render={render} locations={locs} events={evts} renderCal={handleListKey} event={selectedEvent} onClose={handleCloseEventDetails} teachers={teachers} students={students} isList={true} />
      )}
    </div>
  );
};
