...
Shows the calendar view of events by implementing react-big-calendar. Uses component CalendarFilter to 
filter by event type. If click on event, shows ViewEventDetails.  
...
Props: 
 ...
 - render: from AdminClasses. causes the AdminClasslist and AdminCalendar to rerender when new event added
 - filter: boolean. indicates if CalendarFilter should be shown or not. (false if from DashCal)

Parents: AdminClasses, AdminDashCal
Children: CalendarFilter, ViewEventDetails

*/

const localizer = momentLocalizer(moment);

const AdminCalendar = ({ render, evts, locs, teachers, students, filter }) => {
  ...
  return (
    <div className='classes-test-side'>
      <div className='full-height'>
        ...
        {selectedEvent && (
          <ViewEventDetails render={render} renderCal={handleCalendarKey} event={selectedEvent} onClose={handleCloseEventDetails} teachers={teachers} students={students} locations={locs} events={evts} isList={false} />
