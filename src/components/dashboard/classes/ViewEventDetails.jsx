...
Takes in an event and displays its properties, the event details. Contains instaniations of EditEvent and 
DeleteEvent. 
...
Parents: AdminCalendar, AdminClassList
Children: DeleteEvent, EditEvent

*/

const ViewEventDetails = ({ render, event, onClose, locations, renderCal, teachers, students, isList }) => {
      ...
      <div className="event-content">
        ...
        <div>
          {isEditEventVisible ? (
            ...
            <>
              <div className='classes-flex-r-center'>
                <button onClick={handleEditEventClick}>Edit Event</button>
                <DeleteEvent onClose={onClose} event={event} render={render} renderCal={renderCal} isList={isList} />
              </div>
            </>
          )}
        </div>
